...
def train(
    ...
    if PretrainedTrf.is_llm(pretrained_text_transformer):
        ...
        model = TextLlmForClassification(
            ...
            use_ia3=use_ia3,
            use_numero_logic = template_type == TextTransformerTemplateType.DESCRIPTIVE_NUMLOGIC,
        )
    else:
        ...
        #Make the embedding of the new tokens trainable
    ...
    if min_tag_depth is not None:
        experiment_name += f"_min_tag_depth_{min_tag_depth}"
